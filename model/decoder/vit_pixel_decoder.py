...
from .vit_pixel_decoder_basic import Block, precompute_freqs_cis_2d, Upsample
...
if __name__ == "__main__":
    ...
    config = OmegaConf.load("/data1/jjc/codebase/kuaishou/config/vit_decoder_scale_hybird_upsample.yaml")
